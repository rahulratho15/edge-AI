...
/// Service wrapping llamadart for Qwen3.5-0.8B inference (Quantized Q4_K_M).
/// Supports both text and vision (multimodal) generation.
/// Uses reduced context window (2048) optimized for 8GB RAM devices.
class LlmService {
  LlamaEngine? _engine;
  ...
  /// Load the main GGUF model. [contextSize] defaults to 2048 for quantized model
  /// to keep RAM usage optimal on 8GB devices.
