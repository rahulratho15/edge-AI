...
class ModelManager {
  static const String modelFilename = 'LFM2.5-VL-450M-Q4_0.gguf';
  static const String projectorFilename = 'mmproj-LFM2.5-VL-450m-Q8_0.gguf';

  static const String modelUrl =
      'https://huggingface.co/LiquidAI/LFM2.5-VL-450M-GGUF/resolve/main/LFM2.5-VL-450M-Q4_0.gguf?download=true';
  static const String projectorUrl =
      'https://huggingface.co/LiquidAI/LFM2.5-VL-450M-GGUF/resolve/main/mmproj-LFM2.5-VL-450m-Q8_0.gguf?download=true';
  ...
  Future<String> get modelsDir async {
    ...
    final directory = Directory('${documentsDir.path}/lfm25_vl_assets');
  ...
  Future<void> _downloadFile({
    ...
    try {
      ...
      await for (final chunk in response.stream) {
        ...
        final stageProgress = totalBytes > 0 ? receivedBytes / totalBytes : 0.0;
        onProgress(
          ModelDownloadProgress(
            stage: stage,
            title: title,
