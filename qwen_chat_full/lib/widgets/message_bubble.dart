  ...
  Widget _buildMarkdownContent() {
    ...
    return MarkdownBody(
      ...
      styleSheet: MarkdownStyleSheet(
        ...
        listBullet: const TextStyle(color: Color(0xFF80CBC4), fontSize: 15),
        strong:
            const TextStyle(color: Colors.white, fontWeight: FontWeight.bold),
        em: const TextStyle(
            color: Color(0xFFB0BEC5), fontStyle: FontStyle.italic),
        a: const TextStyle(color: Color(0xFF00BCD4)),
      ),
    );
  }
        ...
        return Row(
          ...
          children: List.generate(3, (index) {
            ...
            return Container(
              ...
              decoration: BoxDecoration(
                shape: BoxShape.circle,
                color: const Color(0xFF00BCD4).withValues(alpha: opacity),
              ),
            );
          }),
        );
